...
#define container_of(ptr, type, member) /*lint -e413*/\
...
extern void rb_link_node(rb_node_t * node, rb_node_t * parent, rb_node_t ** rb_link);
extern void rb_replace_node(rb_node_t *victim, rb_node_t *_new, rb_root_t *root);
