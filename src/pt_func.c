...
pt_char_t *pt_bcd2str(pt_uint8_t *bcds, pt_int32_t bcds_len, pt_char_t *str, pt_int32_t *str_len)
{
    pt_int32_t i, j;
...
pt_uint8_t *pt_str2bcd(pt_char_t *str, pt_int32_t str_len, pt_uint8_t *bcds, pt_int32_t *bcds_len)
{
    pt_int32_t i, j;
